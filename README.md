# Результаты проектной работы 9 спринта
В данном проекте рассматривается кейс компании BionicPRO, для которой необходимо
1. Повышение безопасности системы
   - Задача 1. Доработка архитектуры для повышения безопасности систем.
   ...
   - Задача 4. Подключение LDAP для возможности получения данных о пользователях представительства BionicPRO в другой стране.
   - Задача 5. Настройка MFA.
   - Задача 6. Добавление OAuth 2.0 от Яндекс ID.
   - [TASK1_README.md](_tasks/task1/TASK1_README.md)
2. Реализация сервиса отчётов с внедрением `OLAP` пайлайна данных. [TASK2_README.md](_tasks/task2/TASK2_README.md)
3. Внедрение `CDN` в рамках снежения нагрузки на `OLAP` хранилище. [TASK3_README.md](_tasks/task3/TASK3_README.md)
4. Внедрение `CDC` для снижения нагрузки на `OLTP` источники данных. [TASK4_README.md](_tasks/task4/TASK4_README.md)

-----
># Общее описание проектной работы 9 спринта
>
...
>* CRM.
>
>[Диаграмма контейнеров BionicPRO в модели C4:](_tasks/task1/BionicPRO_C4_containers_AS_IS_drawio.xml)
>- <img src="_tasks/task1/BionicPRO_C4_containers_AS_IS_drawio.drawio.svg" width="1000">
