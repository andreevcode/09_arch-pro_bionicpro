...
### 1.1. ADR. Основные решения
**Название**: Унификация аутентификации, безопасное управление сессиями и разделение трафика
...
### 3.2 ADR. Нюансы настройки веб-безопасности и Spring Security
